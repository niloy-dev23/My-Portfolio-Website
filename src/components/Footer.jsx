...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0F172A] border-t border-[#F1F5F9]/10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="w-full flex justify-between py-5 flex-wrap">
          ...
          <div>
            ...
            <p className="text-[#94A3B8] text-sm leading-relaxed w-60">
            ...
            <ul className="space-y-2">
              {footerLinks.map(({ to, label }) => (
                <li key={to}>
                  <Link
                    to={to}
                    className="text-[#94A3B8] text-sm hover:text-[#60A5FA] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#3B82F6] rounded px-2 py-1 inline-block"
                  >
                    {label}
                  </Link>
                </li>
        ...
        {/* Divider */}
        <div className="h-px bg-[#F1F5F9]/10 mb-6" />
